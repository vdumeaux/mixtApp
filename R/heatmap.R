...
heatmap.map <- function(x, color.scheme=heatmap.color.scheme(), na.color = "grey", use.raster=FALSE)
{
    library("colorspace")
...
heatmap.mark <- function(heatmap.out, marks) {
