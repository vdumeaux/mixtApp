...
huc.clinical.colors <- function() {
  ...
  heatmap.clinical[["hybrid.parker"]] <- c(erp.lumA="blue4", erp.lumB="deepskyblue", erp.normL="green4", erp.her2E="orange", erp.basalL="#7fffd4", ern.her2p="hotpink2", ern.her2n="firebrick2")
  ...
  heatmap.clinical[["lumC"]]<-c(No="white", Yes="#7fffd4")
